...
from data import target_generator
...
def train():
    ...
    if args.version == 'yolo':
        yolo_net = YOLO(device, input_size=train_size, num_classes=num_classes, trainable=True)
    ...
    for epoch in range(args.start_epoch, max_epoch):
        ...
        for iter_i, (images, targets) in enumerate(dataloader):
            ...
            targets = target_generator.gt_creator(input_size=train_size,
